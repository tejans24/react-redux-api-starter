...
```bash
$ git clone https://github.com/refocus-studios/react-redux-api-stater <my-project-name>
$ cd <my-project-name>
```
...
|------------------|-----------|
|`start`|Serves your app at `localhost:3000`, Api on `localhost:3001`. HMR will be enabled in development.|
...
```
.
|── api                      # Contains all the files required for building a REST API using express
  #more api structure needs to be explained later
